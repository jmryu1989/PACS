...
BASE = (
    ("invariants_live.py", None, "candidate-invariants", 79),
...
def exact_selection(target, runner):
    ...
    require(len(selected) == 101 and len({(x["file"], x["case"]) for x in selected}) == 101,
            "Candidate selection must contain 101 unique exact cases")
