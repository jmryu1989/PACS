...
영상 소견 목록·이동(S2-B1): `node --test tests/finding_command_test.cjs` (22개, `finding_link_model_test.cjs`가 같은 프로세스에서 함께 실행)와
...
최신 명령만의 알림과 A-B-A·403/404/503·세션 종료 목록 폐기를 출하 코드와 별도 vm 영상 문서로 확인한다. 브라우저 시험은 실제 영상의
