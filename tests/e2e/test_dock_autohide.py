...
class DockAutohideE2E(DockAccountE2E):
 ...
 def test_auto_03_account_legacy_load_and_session(self):
  ...
  legacy=json.loads(json.dumps(saved));legacy['sizes']['version']=4;legacy['sizes']['dock']=dict(version=1,placement='top',panel=0)
