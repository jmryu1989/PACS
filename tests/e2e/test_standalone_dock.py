...
class StandaloneDockE2E(ViewerTechNoteE2E):
 ...
 def test_standalone_dock_06_default_layout_and_retained_input(self):
  ...
  expect(v.locator('#kin-workspace-dock')).to_have_count(1,timeout=45000)
  expect(v.locator('#kin-viewer-layout')).not_to_be_visible();expect(v.locator('#kin-viewer-history')).not_to_be_visible()
  ...
  v.screenshot(path=str(folder/'viewer-comparison.png'))
