...
class WorkspacePersistenceE2E(PortraitWorkspaceE2E):
    ...
    def test_d02b_accounts_and_devices(self):
        ...
        self.open_toolbar_group(ax,'#layout-toggle')
        ...
        self.open_toolbar_group(bx,'#layout-toggle')
        ...
        self.open_toolbar_group(ay,'#layout-toggle')
        ...
        self.mode_is(ay,'landscape')
        self.assertEqual(self.stored(ax),a_state)
        self.open_toolbar_group(ax,'#layout-reset')
