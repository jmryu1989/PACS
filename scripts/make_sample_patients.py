...
PATIENTS = [
    # (이름 DICOM 형식: 성^이름, ID, 생년월일, 성별, 검사일, 검사설명)
    ("KIM^CHULSOO",  "P-1001", "19620304", "M", "20260828", "Brain CT (synthetic)"),
    ("LEE^YOUNGHEE", "P-1002", "19751122", "F", "20260827", "Brain CT (synthetic)"),
    ("PARK^MINJUN",  "P-1003", "19881009", "M", "20260827", "Brain CT f/u (synthetic)"),
    ("CHOI^SUJIN",   "P-1004", "19930517", "F", "20260826", "Brain CT (synthetic)"),
    ("JUNG^DOHYUN",  "P-1005", "19570230".replace("30", "28"), "M", "20260825", "Brain CT f/u (synthetic)"),
]
...
def main() -> None:
    ...
    for pi, (name, pid, birth, sex, date, desc) in enumerate(PATIENTS):
        ...
        for i in range(N_SLICES):
            ...
            r.raise_for_status()
            total += 1
        print(f"OK: {name} ({pid}) — {N_SLICES}슬라이스 업로드")
