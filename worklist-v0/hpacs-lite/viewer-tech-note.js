  ...
  function mount(){
    ...
    if(window.top!==window){
      ...
      const enable=options=>{
        ...
        orientation=window.KinVolumeOrientation&&window.kinCreateVolumeOrientation?.({services,selected:selectedStudy,owner:()=>identity,live:()=>{try{return live()&&options.owner()===bound;}catch(_){return false;}},allowed:contextLive,host});
